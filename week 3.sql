...
update branch set assets=0.5
where branch_name='sbi_chamrajpet';
select * from branch;

update branch set assets=0.2
where branch_name='sbi_jantarMantar';
select * from branch;

update branch set assets=0.1
where branch_name='sbi_parliamentRoad';
select * from branch;
...
update branch set assets=0.2
where branch_name='sbi_shivajiRoad';
select * from branch;
